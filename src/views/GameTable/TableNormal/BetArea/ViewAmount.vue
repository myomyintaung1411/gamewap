...
<view :id='_VIEW_ID' :class='["viewamount-model", hasWaitAmount && "_hasWaitAmount"]'>
  ...
  <template v-if='amount'>
    <!-- :style='{ top:`${_posTop}px`, left:`${_posLeft}px`, }' -->
    <div class='viewamount-_view div02' :style='{ top:`10px`, left:`10px`, }'>
...
<style lang='less' src='@front/zstyles/views/GameTable/TableNormal/BetArea/ViewAmount.less' scoped></style>
